...
CUMULIS_JAR=`ls ${current_rel_dir}/kc_rslbe_dl3-*.jar`
...
java -Xms512m -Xmx4g -XX:MetaspaceSize=512m -Djava.security.egd=file:/dev/./urandom -cp ${CLASSPATH} -Dlog4j.configurationFile=${current_rel_dir}/conf/log4j2-dl3.xml com.kaiostech.kc_rslbe_dl3.CumulisDL "$1" "$2" "$3" "$4" "$5" "$6" "$7" "$8" "$9"
